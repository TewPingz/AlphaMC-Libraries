...
public class RecordTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
        ...
        TypeAdapter<T> delegate = GsonProvider.getGson().getDelegateAdapter(this, type);
        return new TypeAdapter<>() {
            ...
            public T read(JsonReader reader) throws IOException {
                ...
                while (reader.hasNext()) {
                    ...
                    if (type != null) {
                        argsMap.put(name, GsonProvider.getGson().getAdapter(type).read(reader));
                    } else {
                        GsonProvider.getGson().getAdapter(Object.class).read(reader);
                    }
