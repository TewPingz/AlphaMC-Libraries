...
public final class VectorUtils {
    ...
    public static Vector rotateAroundAxisX(Vector v, double angle) {
        double y, z, cos, sin;
        cos = ParticleMath.cos(angle);
        sin = ParticleMath.sin(angle);
    ...
    public static Vector rotateVector(Vector v, float yawDegrees, float pitchDegrees) {
        ...
        double cosYaw = ParticleMath.cos(yaw);
        double cosPitch = ParticleMath.cos(pitch);
        double sinYaw = ParticleMath.sin(yaw);
        double sinPitch = ParticleMath.sin(pitch);
